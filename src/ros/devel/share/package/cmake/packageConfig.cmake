...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/hashtomte/Twizzly-Security/src/ros/src/package)
  set(package_DEVEL_PREFIX /home/hashtomte/Twizzly-Security/src/ros/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/hashtomte/Twizzly-Security/src/ros/install)
...
if(NOT "/home/hashtomte/Twizzly-Security/src/ros/devel/include " STREQUAL " ")
  set(package_INCLUDE_DIRS "")
  set(_include_dirs "/home/hashtomte/Twizzly-Security/src/ros/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'hashtomte <hashtomte@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hashtomte/Twizzly-Security/src/ros/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hashtomte/Twizzly-Security/src/ros/devel/lib;/home/hashtomte/ros/devel/lib;/opt/ros/lunar/lib)
