...
set(MSG_I_FLAGS "-Ipackage:/home/hashtomte/Twizzly-Security/src/ros/src/package/msg;-Istd_msgs:/opt/ros/lunar/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/hashtomte/Twizzly-Security/src/ros/src/package/msg/Num.msg" NAME_WE)
add_custom_target(_package_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "package" "/home/hashtomte/Twizzly-Security/src/ros/src/package/msg/Num.msg" ""
)
...
_generate_msg_cpp(package
  "/home/hashtomte/Twizzly-Security/src/ros/src/package/msg/Num.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package\")")
  # install generated code
  install(
