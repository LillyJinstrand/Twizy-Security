...
void TableStruct::InitDefaultsImpl() {
  ...
  _Junction_default_instance_.get_mutable()->id_ = const_cast< ::apollo::hdmap::Id*>(
      ::apollo::hdmap::Id::internal_default_instance());
  _Junction_default_instance_.get_mutable()->polygon_ = const_cast< ::apollo::hdmap::Polygon*>(
