...
class Feature : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.prediction.Feature) */ {
 public:
  ...
  static const int kTVelocityFieldNumber = 17;
  const ::apollo::common::Point3D& t_velocity() const;
  ::apollo::common::Point3D* mutable_t_velocity();
  ::apollo::common::Point3D* release_t_velocity();
  void set_allocated_t_velocity(::apollo::common::Point3D* t_velocity);

  // optional .apollo.common.Point3D t_acceleration = 20;
  bool has_t_acceleration() const;
  void clear_t_acceleration();
  static const int kTAccelerationFieldNumber = 20;
  const ::apollo::common::Point3D& t_acceleration() const;
  ::apollo::common::Point3D* mutable_t_acceleration();
  ::apollo::common::Point3D* release_t_acceleration();
  void set_allocated_t_acceleration(::apollo::common::Point3D* t_acceleration);
  ...
  static const int kTVelocityHeadingFieldNumber = 18;
  ...
  void clear_t_speed();
  static const int kTSpeedFieldNumber = 19;
  ...
  void clear_t_acc();
  static const int kTAccFieldNumber = 21;
  double t_acc() const;
