...
// @@protoc_insertion_point(message_clear_start:apollo.drivers.DelphiESR)
  ...
  if (_has_bits_[0 / 32] & 255u) {
    ...
    if (has_esr_status9_5e8()) {
      ...
      esr_status9_5e8_->::apollo::drivers::Esr_status9_5e8::Clear();
    }
    if (has_esr_status6_5e5()) {
      GOOGLE_DCHECK(esr_status6_5e5_ != NULL);
      esr_status6_5e5_->::apollo::drivers::Esr_status6_5e5::Clear();
    }
    if (has_esr_status5_5e4()) {
      GOOGLE_DCHECK(esr_status5_5e4_ != NULL);
      esr_status5_5e4_->::apollo::drivers::Esr_status5_5e4::Clear();
    }
    if (has_esr_status3_4e2()) {
      GOOGLE_DCHECK(esr_status3_4e2_ != NULL);
      esr_status3_4e2_->::apollo::drivers::Esr_status3_4e2::Clear();
    }
    if (has_esr_status4_4e3()) {
      GOOGLE_DCHECK(esr_status4_4e3_ != NULL);
      esr_status4_4e3_->::apollo::drivers::Esr_status4_4e3::Clear();
    }
    if (has_acm_inst_req_7e0()) {
      GOOGLE_DCHECK(acm_inst_req_7e0_ != NULL);
      acm_inst_req_7e0_->::apollo::drivers::Acm_inst_req_7e0::Clear();
    }
    if (has_esr_valid1_5d0()) {
      GOOGLE_DCHECK(esr_valid1_5d0_ != NULL);
      esr_valid1_5d0_->::apollo::drivers::Esr_valid1_5d0::Clear();
    }
  }
  if (_has_bits_[8 / 32] & 65280u) {
    if (has_esr_valid2_5d1()) {
      GOOGLE_DCHECK(esr_valid2_5d1_ != NULL);
      esr_valid2_5d1_->::apollo::drivers::Esr_valid2_5d1::Clear();
    }
    if (has_acm_inst_resp_7e4()) {
      GOOGLE_DCHECK(acm_inst_resp_7e4_ != NULL);
      acm_inst_resp_7e4_->::apollo::drivers::Acm_inst_resp_7e4::Clear();
    }
    if (has_vehicle2_4f1()) {
      GOOGLE_DCHECK(vehicle2_4f1_ != NULL);
      vehicle2_4f1_->::apollo::drivers::Vehicle2_4f1::Clear();
    }
    if (has_vehicle1_4f0()) {
      GOOGLE_DCHECK(vehicle1_4f0_ != NULL);
      vehicle1_4f0_->::apollo::drivers::Vehicle1_4f0::Clear();
    }
    if (has_esr_sim1_5c0()) {
      GOOGLE_DCHECK(esr_sim1_5c0_ != NULL);
      esr_sim1_5c0_->::apollo::drivers::Esr_sim1_5c0::Clear();
    }
    if (has_esr_status1_4e0()) {
      GOOGLE_DCHECK(esr_status1_4e0_ != NULL);
      esr_status1_4e0_->::apollo::drivers::Esr_status1_4e0::Clear();
    }
    if (has_esr_status2_4e1()) {
      GOOGLE_DCHECK(esr_status2_4e1_ != NULL);
      esr_status2_4e1_->::apollo::drivers::Esr_status2_4e1::Clear();
    }
    if (has_esr_status8_5e7()) {
      GOOGLE_DCHECK(esr_status8_5e7_ != NULL);
      esr_status8_5e7_->::apollo::drivers::Esr_status8_5e7::Clear();
    }
  }
  if (_has_bits_[16 / 32] & 2031616u) {
    if (has_esr_status7_5e6()) {
      GOOGLE_DCHECK(esr_status7_5e6_ != NULL);
      esr_status7_5e6_->::apollo::drivers::Esr_status7_5e6::Clear();
    }
    if (has_vehicle3_5f2()) {
      GOOGLE_DCHECK(vehicle3_5f2_ != NULL);
      vehicle3_5f2_->::apollo::drivers::Vehicle3_5f2::Clear();
    }
    if (has_vehicle4_5f3()) {
      GOOGLE_DCHECK(vehicle4_5f3_ != NULL);
      vehicle4_5f3_->::apollo::drivers::Vehicle4_5f3::Clear();
    }
    if (has_vehicle5_5f4()) {
      GOOGLE_DCHECK(vehicle5_5f4_ != NULL);
      vehicle5_5f4_->::apollo::drivers::Vehicle5_5f4::Clear();
    }
    if (has_vehicle6_5f5()) {
      GOOGLE_DCHECK(vehicle6_5f5_ != NULL);
      vehicle6_5f5_->::apollo::drivers::Vehicle6_5f5::Clear();
    }
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
