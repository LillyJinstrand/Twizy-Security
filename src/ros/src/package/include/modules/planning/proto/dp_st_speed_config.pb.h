...
class DpStSpeedConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.DpStSpeedConfig) */ {
 public:
  ...
  static const int kStBoundaryConfigFieldNumber = 33;
  ...
  static const int kAccelPenaltyFieldNumber = 16;
  ...
  static const int kDecelPenaltyFieldNumber = 17;
  ...
  static const int kPositiveJerkCoeffFieldNumber = 18;
  ...
  static const int kNegativeJerkCoeffFieldNumber = 19;
  ...
  static const int kMaxDecelerationFieldNumber = 21;
  ...
  bool has_keep_clear_cost_factor() const;
  void clear_keep_clear_cost_factor();
  static const int kKeepClearCostFactorFieldNumber = 50;
  double keep_clear_cost_factor() const;
  void set_keep_clear_cost_factor(double value);
 ...
 private:
  ...
  void set_has_keep_clear_cost_factor();
  void clear_has_keep_clear_cost_factor();
  ...
  double keep_clear_cost_factor_;
...
// optional double keep_clear_cost_factor = 50 [default = 1000];
inline bool DpStSpeedConfig::has_keep_clear_cost_factor() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void DpStSpeedConfig::set_has_keep_clear_cost_factor() {
  _has_bits_[0] |= 0x00400000u;
}
inline void DpStSpeedConfig::clear_has_keep_clear_cost_factor() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void DpStSpeedConfig::clear_keep_clear_cost_factor() {
  keep_clear_cost_factor_ = 1000;
  clear_has_keep_clear_cost_factor();
}
inline double DpStSpeedConfig::keep_clear_cost_factor() const {
  // @@protoc_insertion_point(field_get:apollo.planning.DpStSpeedConfig.keep_clear_cost_factor)
  return keep_clear_cost_factor_;
}
inline void DpStSpeedConfig::set_keep_clear_cost_factor(double value) {
