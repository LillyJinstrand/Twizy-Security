...
#ifndef PROTOBUF_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto__INCLUDED
#define PROTOBUF_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto__INCLUDED
...
class MPCControllerConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.control.MPCControllerConf) */ {
 public:
  ...
  inline MPCControllerConf* New() const PROTOBUF_FINAL { return New(NULL); }

  MPCControllerConf* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  void set_has_steer_weight_gain_scheduler();
  void clear_has_steer_weight_gain_scheduler();
  void set_has_feedforwardterm_gain_scheduler();
  void clear_has_feedforwardterm_gain_scheduler();
  ...
  friend struct protobuf_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto::TableStruct;
};
// ===================================================================
...
#endif  // PROTOBUF_modules_2fcontrol_2fproto_2fmpc_5fcontroller_5fconf_2eproto__INCLUDED
